...
open class SecureTextToggleButton: UIButton {
    ...
    {
        self.setImage(showSecureTextImage.withRenderingMode(UIImage.RenderingMode.alwaysTemplate),for: State())
    }
    ...
    {
        self.setImage(hideSecureTextImage.withRenderingMode(UIImage.RenderingMode.alwaysTemplate),for: State())
    }
